...
<div class="container">
    ...
    <div class="text text-left" style="font-size: Large;" > Votre destination, notre priorité - voyagez en toute confiance avec notre service de taxi de qualité supérieure !! </div> 

        <div class="col-md-14">
        <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="presentation-img">
                        <img src="https://img.freepik.com/free-vector/taxi-app-concept-illustration_52683-36028.jpg?size=626&ext=jpg&ga=GA1.2.1458678969.1680179954&semt=sph" alt="Image de programmation">
                        </div>
                    </div>
                    <div class="col-md-6">
            <div class="card">
                <div class="card-header" col>{{ __('Register') }}</div>
